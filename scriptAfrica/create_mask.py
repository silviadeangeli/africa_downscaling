...
# original inputs
sFileGUF =       "E:/africa_downscaling/gm/GM_GUF_100.tif"
sFileGHSL =      "E:/africa_downscaling/gm/GM_GHSL_38.tif"
sFileWorldPop =  "E:/africa_downscaling/gm/GM_WP_100.tif"
sFileFinalGrid = "E:/africa_downscaling/gm/gm_GAUL.tif"

# output directory
dir_out="E:/africa_downscaling/gm/masks_out"

if not os.path.exists (dir_out):
    os.mkdir(dir_out)

# regridded outputs
sFileGUF_regrid = join(dir_out, "GM_buiA_GUF_90m.tif")
sFileGHSL_regrid = join(dir_out, "GM_buiA_GHSL_90m.tif")
sFileWorldPop_regrid = join(dir_out, "GM_pop_WP_90m.tif")

# regridded merged outputs
sFileGHSL_GUF_regrid = join(dir_out, "GM_buiA_GHSL_GUF_90m.tif")
sFileMaskWPop2  = join(dir_out, "GM_buiA_GHSL_GUF_wp2_90m.tif")
sFileMaskWPop3  = join(dir_out, "GM_buiA_GHSL_GUF_wp3_90m.tif")
sFileMaskWPop5  = join(dir_out, "GM_buiA_GHSL_GUF_wp5_90m.tif")
sFileMaskWPop10 = join(dir_out, "GM_buiA_GHSL_GUF_wp10_90m.tif")
